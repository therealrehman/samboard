...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    private void updateShapeMask(int i5, int i7) {
        this.destination.set(getPaddingLeft(), getPaddingTop(), i5 - getPaddingRight(), i7 - getPaddingBottom());
        this.pathProvider.calculatePath(this.shapeAppearanceModel, 1.0f, this.destination, this.path);
        this.maskPath.rewind();
        this.maskPath.addPath(this.path);
        this.maskRect.set(0.0f, 0.0f, i5, i7);
    ...
    public void setContentPadding(int i5, int i7, int i9, int i10) {
        ...
        super.setPadding((super.getPaddingLeft() - this.leftContentPadding) + i5, (super.getPaddingTop() - this.topContentPadding) + i7, (super.getPaddingRight() - this.rightContentPadding) + i9, (super.getPaddingBottom() - this.bottomContentPadding) + i10);
        this.leftContentPadding = i5;
        this.topContentPadding = i7;
        this.rightContentPadding = i9;
        this.bottomContentPadding = i10;
    }

    public void setContentPaddingRelative(int i5, int i7, int i9, int i10) {
        super.setPaddingRelative((super.getPaddingStart() - getContentPaddingStart()) + i5, (super.getPaddingTop() - this.topContentPadding) + i7, (super.getPaddingEnd() - getContentPaddingEnd()) + i9, (super.getPaddingBottom() - this.bottomContentPadding) + i10);
        this.leftContentPadding = isRtl() ? i9 : i5;
        this.topContentPadding = i7;
        if (!isRtl()) {
            i5 = i9;
        }
    ...
    public void setPadding(int i5, int i7, int i9, int i10) {
        super.setPadding(getContentPaddingLeft() + i5, getContentPaddingTop() + i7, getContentPaddingRight() + i9, getContentPaddingBottom() + i10);
    }

    @Override // android.view.View
    public void setPaddingRelative(int i5, int i7, int i9, int i10) {
        super.setPaddingRelative(getContentPaddingStart() + i5, getContentPaddingTop() + i7, getContentPaddingEnd() + i9, getContentPaddingBottom() + i10);
    }
    ...
    public void setStrokeColorResource(int i5) {
        setStrokeColor(a.f(getContext(), i5));
    }
    ...
    public ShapeableImageView(Context context, AttributeSet attributeSet, int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, R.styleable.ShapeableImageView, i5, i7);
        setLayerType(2, null);
