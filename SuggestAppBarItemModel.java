...
public class SuggestAppBarItemModel<T extends SuggestAppBarItemView> extends SuggestAppBarModel<T> {
    ...
    public static final class Builder {
        ...
        private final <T extends SuggestAppBarItemView> SuggestAppBarItemModel<T> create() {
        ...
        public final SuggestAppBarItemModel<SuggestAppBarItemView> build() {
            InterfaceC0757d interfaceC0757dB = w.f11853a.b(SuggestAppBarItemView.class);
            ...
            return new SuggestAppBarItemModel<>(interfaceC0757dB, context, str, onClickListener, new ButtonListModel(buttonStyle, this.buttons));
        }
    ...
    public SuggestAppBarItemModel(InterfaceC0757d kclazz, Context context, String str, AppBarModel.OnClickListener onClickListener, ButtonListModel buttonListModel) {
