...
public class MaterialSwitch extends SwitchCompat {
    ...
    private static void setInterpolatedDrawableTintIfPossible(Drawable drawable, ColorStateList colorStateList, int[] iArr, int[] iArr2, float f2) {
        ...
        a.g(drawable, d.b(colorStateList.getColorForState(iArr, 0), colorStateList.getColorForState(iArr2, 0), f2));
    }
    ...
    public void setThumbIconResource(int i5) {
        setThumbIconDrawable(f.y(getContext(), i5));
    }
    ...
    public void setTrackDecorationResource(int i5) {
        setTrackDecorationDrawable(f.y(getContext(), i5));
    }
    ...
    public MaterialSwitch(Context context, AttributeSet attributeSet, int i5) {
        ...
        S1 s1ObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, R.styleable.MaterialSwitch, i5, i7, new int[0]);
        this.thumbIconDrawable = s1ObtainTintedStyledAttributes.b(R.styleable.MaterialSwitch_thumbIcon);
        int i9 = R.styleable.MaterialSwitch_thumbIconSize;
        TypedArray typedArray = s1ObtainTintedStyledAttributes.f6522b;
        this.thumbIconSize = typedArray.getDimensionPixelSize(i9, -1);
        this.thumbIconTintList = s1ObtainTintedStyledAttributes.a(R.styleable.MaterialSwitch_thumbIconTint);
        int i10 = typedArray.getInt(R.styleable.MaterialSwitch_thumbIconTintMode, -1);
        PorterDuff.Mode mode = PorterDuff.Mode.SRC_IN;
        this.thumbIconTintMode = ViewUtils.parseTintMode(i10, mode);
        this.trackDecorationDrawable = s1ObtainTintedStyledAttributes.b(R.styleable.MaterialSwitch_trackDecoration);
        this.trackDecorationTintList = s1ObtainTintedStyledAttributes.a(R.styleable.MaterialSwitch_trackDecorationTint);
