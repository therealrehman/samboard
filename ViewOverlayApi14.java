...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    public static class OverlayViewGroup extends ViewGroup {
        ...
        public ViewParent invalidateChildInParentFast(int i5, int i7, Rect rect) {
            if (this.hostView == null || invalidateChildInParentFastMethod == null) {
                return null;
            }
            try {
                getOffset(new int[2]);
                invalidateChildInParentFastMethod.invoke(this.hostView, Integer.valueOf(i5), Integer.valueOf(i7), rect);
                return null;
