...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private BadgeDrawable(Context context, int i5, int i7, int i9, BadgeState.State state) {
        ...
        BadgeState badgeState = new BadgeState(context, i5, i7, i9, state);
    ...
    private void autoAdjustWithinGrandparentBounds(View view) {
        ...
        if (customBadgeParent == null) {
            ...
            y4 = customBadgeParent.getY();
            x9 = customBadgeParent.getX();
            customBadgeParent = (View) customBadgeParent.getParent();
        }
        float topCutOff = getTopCutOff(customBadgeParent, y4);
        float leftCutOff = getLeftCutOff(customBadgeParent, x9);
        float bottomCutOff = getBottomCutOff(customBadgeParent, y4);
        float rightCutoff = getRightCutoff(customBadgeParent, x9);
        if (topCutOff < 0.0f) {
