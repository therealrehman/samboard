...
class FloatingActionButtonImpl {
    ...
    public class AnonymousClass5 implements TypeEvaluator<Float> {
        ...
        public Float evaluate(float f2, Float f7, Float f9) {
            float fFloatValue = this.floatEvaluator.evaluate(f2, (Number) f7, (Number) f9).floatValue();
            if (fFloatValue < 0.1f) {
                fFloatValue = 0.0f;
            }
    ...
    private AnimatorSet createAnimator(MotionSpec motionSpec, float f2, float f7, float f9) {
    ...
    private AnimatorSet createDefaultAnimator(final float f2, final float f7, final float f9, int i5, int i7) {
        AnimatorSet animatorSet = new AnimatorSet();
        ArrayList arrayList = new ArrayList();
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.floatingactionbutton.FloatingActionButtonImpl.4
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                FloatingActionButtonImpl.this.imageMatrixScale = AnimationUtils.lerp(f10, f9, fFloatValue);
                FloatingActionButtonImpl.this.calculateImageMatrixFromScale(AnimationUtils.lerp(f10, f9, fFloatValue), matrix);
        ...
        animatorSet.setInterpolator(MotionUtils.resolveThemeInterpolator(this.view.getContext(), i7, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        return animatorSet;
    }
    ...
    public void hide(final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z9) {
        if (isOrWillBeHidden()) {
            return;
        }
    ...
    public void onPaddingUpdated(Rect rect) {
        AbstractC0582a.o(this.contentBackground, "Didn't initialize content background");
        if (!shouldAddPadding()) {
    ...
    public void setRippleColor(ColorStateList colorStateList) {
        ...
        if (drawable != null) {
            a.h(drawable, RippleUtils.sanitizeRippleDrawableColor(colorStateList));
        }
    }
    ...
    public void show(final InternalVisibilityChangedListener internalVisibilityChangedListener, final boolean z9) {
        if (isOrWillBeShown()) {
            return;
        }
        Animator animator = this.currentAnimator;
        ...
        if (!shouldAnimateVisibilityChange()) {
            this.view.internalSetVisibility(0, z9);
