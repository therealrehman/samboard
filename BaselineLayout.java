...
public class BaselineLayout extends ViewGroup {
    ...
    public void onLayout(boolean z9, int i5, int i7, int i9, int i10) {
        ...
        int paddingRight = ((i9 - i5) - getPaddingRight()) - paddingLeft;
    ...
    public void onMeasure(int i5, int i7) {
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(iMax2, getSuggestedMinimumWidth()), i5, iCombineMeasuredStates), View.resolveSizeAndState(Math.max(iMax, getSuggestedMinimumHeight()), i7, iCombineMeasuredStates << 16));
    }
