...
final class LinearIndeterminateDisjointAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void updateSegmentPositions(int i5) {
        for (int i7 = 0; i7 < 4; i7++) {
            this.segmentPositions[i7] = Math.max(0.0f, Math.min(1.0f, this.interpolatorArray[i7].getInterpolation(getFractionInRange(i5, DELAY_TO_MOVE_SEGMENT_ENDS[i7], DURATION_TO_MOVE_SEGMENT_ENDS[i7]))));
        }
    }
