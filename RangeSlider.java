...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    public interface OnChangeListener extends BaseOnChangeListener<RangeSlider> {
        ...
        void onValueChange(RangeSlider rangeSlider, float f2, boolean z9);
    }
    ...
    public RangeSlider(Context context, AttributeSet attributeSet, int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.RangeSlider, i5, BaseSlider.DEF_STYLE_RES, new int[0]);
        int i7 = R.styleable.RangeSlider_values;
        if (typedArrayObtainStyledAttributes.hasValue(i7)) {
            setValues(convertToFloat(typedArrayObtainStyledAttributes.getResources().obtainTypedArray(typedArrayObtainStyledAttributes.getResourceId(i7, 0))));
        }
