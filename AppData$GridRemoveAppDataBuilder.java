...
public final class AppData$GridRemoveAppDataBuilder {
    ...
    public AppData$GridRemoveAppDataBuilder(C1281b appInfo) {
        j.f(appInfo, "appInfo");
    ...
    public final AppData$GridRemoveAppDataBuilder setDimmed(boolean dimmed) {
        this.dimmed = dimmed;
        return this;
    }

    public final AppData$GridRemoveAppDataBuilder setIcon(Drawable icon) {
        this.icon = icon;
        return this;
    }

    public final AppData$GridRemoveAppDataBuilder setLabel(String label) {
        this.label = label;
        return this;
    }

    public final AppData$GridRemoveAppDataBuilder setSelected(boolean selected) {
        this.selected = selected;
        return this;
    }

    public final AppData$GridRemoveAppDataBuilder setSubIcon(Drawable subIcon) {
        this.subIcon = subIcon;
        return this;
    }

    public final AppData$GridRemoveAppDataBuilder setSubLabel(String subLabel) {
        this.subLabel = subLabel;
        return this;
    }

    public c build() {
        return new d(this.appInfo, 3, this.icon, this.subIcon, this.label, this.subLabel, null, null, this.selected, this.dimmed, false, 1216);
    }

    /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
    public AppData$GridRemoveAppDataBuilder(c appInfoData) {
        this(appInfoData.o());
