...
public class TooltipDrawable extends MaterialShapeDrawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private TooltipDrawable(Context context, AttributeSet attributeSet, int i5, int i7) {
    ...
    public static TooltipDrawable createFromAttributes(Context context, AttributeSet attributeSet, int i5, int i7) {
        TooltipDrawable tooltipDrawable = new TooltipDrawable(context, attributeSet, i5, i7);
        tooltipDrawable.loadFromAttributes(attributeSet, i5, i7);
    ...
    private void loadFromAttributes(AttributeSet attributeSet, int i5, int i7) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, R.styleable.Tooltip, i5, i7, new int[0]);
        ...
        if (textAppearance != null) {
            ...
            if (typedArrayObtainStyledAttributes.hasValue(i9)) {
                textAppearance.setTextColor(MaterialResources.getColorStateList(this.context, typedArrayObtainStyledAttributes, i9));
            }
        }
    ...
    public void draw(Canvas canvas) {
        ...
        float f2 = (float) (-((Math.sqrt(2.0d) * ((double) this.arrowSize)) - ((double) this.arrowSize)));
