...
@InterfaceC0463a
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0010 \n\u0000\n\u0002\u0018\u0002\n\u0002\u0010\u000b\n\u0002\u0018\u0002\n\u0002\b\u0007\n\u0002\u0010!\n\u0002\b\u0004\b\u0011\u0018\u00002\u00020\u00012\u00020\u0002B+\u0012\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00010\u0003\u0012\u0014\b\u0002\u0010\b\u001a\u000e\u0012\u0004\u0012\u00020\u0006\u0012\u0004\u0012\u00020\u00070\u0005¢\u0006\u0004\b\t\u0010\nJ\u000f\u0010\u000b\u001a\u00020\u0007H\u0002¢\u0006\u0004\b\u000b\u0010\fJ\u000f\u0010\r\u001a\u00020\u0007H\u0002¢\u0006\u0004\b\r\u0010\fJ\u000f\u0010\u000e\u001a\u00020\u0007H\u0016¢\u0006\u0004\b\u000e\u0010\fR\u001a\u0010\u0004\u001a\b\u0012\u0004\u0012\u00020\u00010\u000f8\u0002X\u0082\u0004¢\u0006\u0006\n\u0004\b\u0004\u0010\u0010R\u0018\u0010\u0011\u001a\u0004\u0018\u00010\u00028\u0002@\u0002X\u0082\u000e¢\u0006\u0006\n\u0004\b\u0011\u0010\u0012¨\u0006\u0013"}, d2 = {"Landroidx/picker/loader/select/CategorySelectableItem;", "Landroidx/picker/loader/select/SelectableItem;", "Ly8/G;", "", "selectableItemList", "Lkotlin/Function1;", "", "LT6/p;", "onUpdated", "<init>", "(Ljava/util/List;Lg7/b;)V", "bindSelectableItemList", "()V", "updateAllAppsStatus", "dispose", "", "Ljava/util/List;", "disposableHandle", "Ly8/G;", "picker-app_release"}, k = 1, mv = {1, 8, 0})
public class CategorySelectableItem extends SelectableItem implements G {
    private G disposableHandle;
    private final List<SelectableItem> selectableItemList;

    public /* synthetic */ CategorySelectableItem(List list, InterfaceC0562b interfaceC0562b, int i5, e eVar) {
        this(list, (i5 & 2) != 0 ? C1205b.f14958g : interfaceC0562b);
    }
    ...
    private final void bindSelectableItemList() {
        ...
        G gRegisterAfterChangeUpdateListener$picker_app_release = registerAfterChangeUpdateListener$picker_app_release(new C1208e(this, 0));
        List<SelectableItem> list = this.selectableItemList;
        ArrayList arrayList = new ArrayList(p.c0(list, 10));
        Iterator<T> it = list.iterator();
        while (it.hasNext()) {
            arrayList.add(((SelectableItem) it.next()).registerAfterChangeUpdateListener$picker_app_release(new C1208e(this, 1)));
        }
        this.disposableHandle = new C1204a(gRegisterAfterChangeUpdateListener$picker_app_release, arrayList, 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void bindSelectableItemList$lambda$3(G disposable1, List disposableHandleList) {
    ...
    public CategorySelectableItem(List<? extends SelectableItem> selectableItemList, InterfaceC0562b onUpdated) {
