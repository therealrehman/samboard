...
final class CircularIndeterminateAnimatorDelegate extends IndeterminateAnimatorDelegate<ObjectAnimator> {
    ...
    private void maybeUpdateSegmentColors(int i5) {
        for (int i7 = 0; i7 < 4; i7++) {
            float fractionInRange = getFractionInRange(i5, DELAY_TO_FADE_IN_MS[i7], 333);
            if (fractionInRange >= 0.0f && fractionInRange <= 1.0f) {
                int i9 = i7 + this.indicatorColorIndexOffset;
    ...
    private void updateSegmentPositions(int i5) {
        ...
        fArr[1] = f2 * 1520.0f;
        for (int i7 = 0; i7 < 4; i7++) {
            float fractionInRange = getFractionInRange(i5, DELAY_TO_EXPAND_IN_MS[i7], 667);
            float[] fArr2 = this.segmentPositions;
            fArr2[1] = (this.interpolator.getInterpolation(fractionInRange) * 250.0f) + fArr2[1];
            float fractionInRange2 = getFractionInRange(i5, DELAY_TO_COLLAPSE_IN_MS[i7], 667);
        ...
        float f7 = fArr4[0];
        float f9 = fArr4[1];
        float f10 = ((f9 - f7) * this.completeEndFraction) + f7;
        fArr4[0] = f10;
        fArr4[0] = f10 / 360.0f;
        fArr4[1] = f9 / 360.0f;
    }
