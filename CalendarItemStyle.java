...
final class CalendarItemStyle {
    ...
    private CalendarItemStyle(ColorStateList colorStateList, ColorStateList colorStateList2, ColorStateList colorStateList3, int i5, ShapeAppearanceModel shapeAppearanceModel, Rect rect) {
        AbstractC0582a.n(rect.left);
        AbstractC0582a.n(rect.top);
        AbstractC0582a.n(rect.right);
        AbstractC0582a.n(rect.bottom);
        this.insets = rect;
    ...
    public static CalendarItemStyle create(Context context, int i5) {
        AbstractC0582a.m("Cannot create a CalendarItemStyle with a styleResId of 0", i5 != 0);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(i5, R.styleable.MaterialCalendarItem);
