...
public final class ComposableRadioButtonViewHolder extends ActionableComposableViewHolder {
    ...
    public static final void bindData$lambda$0(SelectableItem selectableItem, ComposableRadioButtonViewHolder this$0, View view) {
        j.f(selectableItem, "$selectableItem");
        j.f(this$0, "this$0");
        selectableItem.setValue(Boolean.valueOf(this$0.radioButton.isChecked()));
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final boolean bindData$lambda$1(SelectableItem selectableItem, ComposableRadioButtonViewHolder this$0) {
        j.f(selectableItem, "$selectableItem");
        j.f(this$0, "this$0");
        selectableItem.setValue(Boolean.valueOf(!this$0.radioButton.isChecked()));
        return true;
    ...
    public void bindData(h viewData) {
        ...
        this.disposableHandle = selectableItem.bind$picker_app_release(new C0698T(4, this));
        this.radioButton.setOnClickListener(new b(27, selectableItem, this));
        setDoAction(new androidx.picker.features.composable.widget.c(selectableItem, this, 5));
    }

    @Override // androidx.picker.features.composable.ActionableComposableViewHolder, androidx.picker.features.composable.ComposableViewHolder
    public void onBind$picker_app_release(View itemView) {
        j.f(itemView, "itemView");
        AbstractC0876m.n(this.radioButton, itemView.hasOnClickListeners());
