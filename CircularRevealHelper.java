...
public class CircularRevealHelper {
    ...
    private void drawDebugCircle(Canvas canvas, int i5, float f2) {
    ...
    private boolean shouldDrawCircularReveal() {
        CircularRevealWidget.RevealInfo revealInfo = this.revealInfo;
        boolean z9 = revealInfo == null || revealInfo.isInvalid();
        return STRATEGY == 0 ? !z9 && this.hasCircularRevealCache : !z9;
    }
    ...
    public void draw(Canvas canvas) {
        if (shouldDrawCircularReveal()) {
            ...
            if (i5 == 0) {
                ...
                if (i5 != 2) {
                    throw new IllegalStateException(l.o(i5, "Unsupported strategy "));
                }
                this.delegate.actualDraw(canvas);
                if (shouldDrawScrim()) {
                    canvas.drawRect(0.0f, 0.0f, this.view.getWidth(), this.view.getHeight(), this.scrimPaint);
