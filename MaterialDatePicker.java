...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    private static Drawable createHeaderToggleDrawable(Context context) {
        ...
        stateListDrawable.addState(new int[]{R.attr.state_checked}, f.y(context, com.google.android.material.R.drawable.material_ic_calendar_black_24dp));
        stateListDrawable.addState(new int[0], f.y(context, com.google.android.material.R.drawable.material_ic_edit_black_24dp));
    ...
    private void enableEdgeToEdgeIfNeeded(Window window) {
        ...
        final int i5 = viewFindViewById.getLayoutParams().height;
        InterfaceC0226s interfaceC0226s = new InterfaceC0226s() { // from class: com.google.android.material.datepicker.MaterialDatePicker.3
            @Override // androidx.core.view.InterfaceC0226s
            public w0 onApplyWindowInsets(View view, w0 w0Var) {
                int i7 = w0Var.f7266a.f(7).f408b;
                if (i5 >= 0) {
                    viewFindViewById.getLayoutParams().height = i5 + i7;
                    View view2 = viewFindViewById;
                    view2.setLayoutParams(view2.getLayoutParams());
                }
                View view3 = viewFindViewById;
                view3.setPadding(view3.getPaddingLeft(), paddingTop + i7, viewFindViewById.getPaddingRight(), viewFindViewById.getPaddingBottom());
                return w0Var;
            }
        };
        WeakHashMap weakHashMap = W.f7199a;
        M.u(viewFindViewById, interfaceC0226s);
    ...
    private static int getPaddedPickerWidth(Context context) {
        ...
        return ((i5 - 1) * resources.getDimensionPixelOffset(com.google.android.material.R.dimen.mtrl_calendar_month_horizontal_padding)) + (resources.getDimensionPixelSize(com.google.android.material.R.dimen.mtrl_calendar_day_width) * i5) + (dimensionPixelOffset * 2);
    }
    ...
    private void initHeaderToggle(Context context) {
        ...
        W.i(this.headerToggleButton, null);
        updateToggleContentDescription(this.headerToggleButton);
        this.headerToggleButton.setOnClickListener(new B5.c(17, this));
    }
    ...
    public static boolean readMaterialCalendarStyleBoolean(Context context, int i5) {
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(MaterialAttributes.resolveOrThrow(context, com.google.android.material.R.attr.materialCalendarStyle, MaterialCalendar.class.getCanonicalName()), new int[]{i5});
    ...
    private void startPickerFragment() {
        ...
        c0234a.f(com.google.android.material.R.id.mtrl_calendar_frame, this.pickerFragment, null);
        if (c0234a.f7674g) {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        this.background = new MaterialShapeDrawable(context, null, i5, i7);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, com.google.android.material.R.styleable.MaterialCalendar, i5, i7);
    ...
    public static final class Builder<S> {
        ...
        public static Builder<K.c> dateRangePicker() {
        ...
        public MaterialDatePicker<S> build() {
            ...
            S s8 = this.selection;
            if (s8 != null) {
                this.dateSelector.setSelection(s8);
            }
        ...
        public Builder<S> setNegativeButtonContentDescription(int i5) {
        ...
        public Builder<S> setPositiveButtonContentDescription(int i5) {
