...
class CutoutDrawable extends MaterialShapeDrawable {
    ...
    public void setCutout(float f2, float f7, float f9, float f10) {
        if (f2 == this.drawableState.cutoutBounds.left && f7 == this.drawableState.cutoutBounds.top && f9 == this.drawableState.cutoutBounds.right && f10 == this.drawableState.cutoutBounds.bottom) {
            return;
        }
        this.drawableState.cutoutBounds.set(f2, f7, f9, f10);
        invalidateSelf();
    }
