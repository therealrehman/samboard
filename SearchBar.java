...
public class SearchBar extends Toolbar {
    ...
    private int defaultIfZero(int i5, int i7) {
        return i5 == 0 ? i7 : i5;
    }

    private ColorStateList getCompatBackgroundColorStateList(int i5, int i7) {
        int[][] iArr = {new int[]{android.R.attr.state_pressed}, new int[]{android.R.attr.state_focused}, new int[0]};
        int iLayer = MaterialColors.layer(i5, i7);
        return new ColorStateList(iArr, new int[]{iLayer, iLayer, i5});
    }

    private void initBackground(ShapeAppearanceModel shapeAppearanceModel, int i5, float f2, float f7, int i7) {
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(shapeAppearanceModel);
        this.backgroundShape = materialShapeDrawable;
        materialShapeDrawable.initializeElevationOverlay(getContext());
        this.backgroundShape.setElevation(f2);
        if (f7 >= 0.0f) {
            this.backgroundShape.setStroke(f7, i7);
        }
        int color = MaterialColors.getColor(this, com.samsung.android.keyscafe.R.attr.colorControlHighlight);
    ...
    private void layoutChild(View view, int i5, int i7, int i9, int i10) {
        WeakHashMap weakHashMap = W.f7199a;
        if (getLayoutDirection() == 1) {
            view.layout(getMeasuredWidth() - i9, i7, getMeasuredWidth() - i5, i10);
        } else {
            view.layout(i5, i7, i9, i10);
        }
    }
    ...
    private Drawable maybeTintNavigationIcon(Drawable drawable) {
        ...
        E.a.g(drawableMutate, color);
        return drawableMutate;
    }

    private void measureCenterView(int i5, int i7) {
        View view = this.centerView;
        if (view != null) {
            view.measure(i5, i7);
        }
        ...
        if (accessibilityManager != null) {
            ...
            addOnAttachStateChangeListener(new View.OnAttachStateChangeListener() { // from class: com.google.android.material.search.SearchBar.1
                ...
                public void onViewAttachedToWindow(View view) {
                    SearchBar.this.accessibilityManager.addTouchExplorationStateChangeListener(new L.c(SearchBar.this.touchExplorationStateChangeListener));
                }

                @Override // android.view.View.OnAttachStateChangeListener
                public void onViewDetachedFromWindow(View view) {
                    SearchBar.this.accessibilityManager.removeTouchExplorationStateChangeListener(new L.c(SearchBar.this.touchExplorationStateChangeListener));
                }
            });
        }
    }
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        ...
        if (attributeSet.getAttributeValue(NAMESPACE_APP, ThemeParkConstants.TITLE) != null) {
    ...
    public void inflateMenu(int i5) {
        Menu menu = getMenu();
        boolean z9 = menu instanceof androidx.appcompat.view.menu.j;
        if (z9) {
            ((androidx.appcompat.view.menu.j) menu).stopDispatchingItemsChanged();
        }
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i5) {
        ...
        this.defaultNavigationIcon = android.support.v4.media.session.f.y(context2, getDefaultNavigationIconResource());
        this.searchBarAnimationHelper = new SearchBarAnimationHelper();
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.SearchBar, i5, i7, new int[0]);
        ShapeAppearanceModel shapeAppearanceModelBuild = ShapeAppearanceModel.builder(context2, attributeSet, i5, i7).build();
        ...
        int i9 = R.styleable.SearchBar_navigationIconTint;
        if (typedArrayObtainStyledAttributes.hasValue(i9)) {
            this.navigationIconTint = Integer.valueOf(typedArrayObtainStyledAttributes.getColor(i9, -1));
        }
    ...
    public boolean collapse(View view, AppBarLayout appBarLayout, boolean z9) {
    ...
    public boolean expand(View view, AppBarLayout appBarLayout, boolean z9) {
