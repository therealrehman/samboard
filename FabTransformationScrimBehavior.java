...
public class FabTransformationScrimBehavior extends ExpandableTransformationBehavior {
    ...
    private void createScrimAnimation(View view, boolean z9, boolean z10, List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfFloat;
        MotionTiming motionTiming = z9 ? this.expandTiming : this.collapseTiming;
        if (z9) {
            if (!z10) {
                view.setAlpha(0.0f);
            }
    ...
    public AnimatorSet onCreateExpandedStateChangeAnimation(View view, final View view2, final boolean z9, boolean z10) {
        ArrayList arrayList = new ArrayList();
        createScrimAnimation(view2, z9, z10, arrayList, new ArrayList());
