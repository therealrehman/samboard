...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private Pair<Integer, Integer> dataForMode(int i5) {
        ...
        throw new IllegalArgumentException(l.o(i5, "no icon for mode: "));
    }
    ...
    private TimePickerPresenter initializeOrRetrieveActivePresenterForMode(int i5, TimePickerView timePickerView, ViewStub viewStub) {
        if (i5 != 0) {
    ...
    public final Dialog onCreateDialog(Bundle bundle) {
        ...
        MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(context, null, i5, i7);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(null, R.styleable.MaterialTimePicker, i5, i7);
