...
final class ColorResourcesTableCreator {
    ...
    public static class ColorResource {
        ...
        public ColorResource(int i5, String str, int i7) {
            this.name = str;
            this.value = i7;
    ...
    public static class ResChunkHeader {
        ...
        public ResChunkHeader(short s8, short s9, int i5) {
            this.type = s8;
            this.headerSize = s9;
            this.chunkSize = i5;
        }
    ...
    public static class StringPoolChunk {
        ...
        public StringPoolChunk(boolean z9, String... strArr) {
            ...
            int i9 = length + i7;
            this.styledSpansStart = z10 ? size3 + i9 : 0;
            int i10 = size3 + i9 + (z10 ? size : 0);
            this.chunkSize = i10;
    ...
    public static class TypeChunk {
        ...
        public TypeChunk(List<ColorResource> list, Set<Short> set, int i5) {
            ...
            for (int i7 = 0; i7 < list.size(); i7++) {
                this.resEntries[i7] = new ResEntry(i7, list.get(i7).value);
            }
    ...
    public static byte[] stringToByteArray(String str) {
        ...
        for (int i5 = 0; i5 < charArray.length; i5++) {
            ...
            int i7 = i5 * 2;
            bArr[i7 + 2] = bArrCharToByteArray[0];
            bArr[i7 + 3] = bArrCharToByteArray[1];
        }
        bArr[length + 2] = 0;
        bArr[length + 3] = 0;
        return bArr;
