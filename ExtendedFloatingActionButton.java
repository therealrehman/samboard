...
public class ExtendedFloatingActionButton extends MaterialButton implements c {
    ...
    public class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public ChangeSizeStrategy(AnimatorTracker animatorTracker, Size size, boolean z9) {
    ...
    public static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends d {
        ...
        private boolean shouldUpdateVisibility(View view, ExtendedFloatingActionButton extendedFloatingActionButton) {
            return (this.autoHideEnabled || this.autoShrinkEnabled) && ((g) extendedFloatingActionButton.getLayoutParams()).f7159f == view.getId();
        }
        ...
        public void extendOrShow(ExtendedFloatingActionButton extendedFloatingActionButton) {
            ...
            extendedFloatingActionButton.performMotion(z9 ? 3 : 0, z9 ? this.internalAutoShrinkCallback : this.internalAutoHideCallback);
        }
        ...
        public void shrinkOrHide(ExtendedFloatingActionButton extendedFloatingActionButton) {
            boolean z9 = this.autoShrinkEnabled;
            extendedFloatingActionButton.performMotion(z9 ? 2 : 1, z9 ? this.internalAutoShrinkCallback : this.internalAutoHideCallback);
        }
    ...
    private Size getSizeFromExtendStrategyType(int i5) {
        ...
        return i5 != 1 ? i5 != 2 ? new Size() { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.4
            @Override // com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.Size
            public int getHeight() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void performMotion(int i5, final OnChangedCallback onChangedCallback) {
        ...
        if (i5 == 0) {
            ...
            if (i5 != 3) {
                throw new IllegalStateException(l.o(i5, "Unknown strategy type: "));
            }
    ...
    @Override // com.google.android.material.button.MaterialButton, androidx.appcompat.widget.C0191u, android.widget.TextView, android.view.View
    ...
    public void setAnimateShowBeforeLayout(boolean z9) {
        this.animateShowBeforeLayout = z9;
    }
    ...
    public void setExtended(boolean z9) {
        if (this.isExtended == z9) {
            return;
        }
        MotionStrategy motionStrategy = z9 ? this.extendStrategy : this.shrinkStrategy;
        if (motionStrategy.shouldCancel()) {
            return;
        }
        motionStrategy.performNow();
    ...
    @Override // android.widget.TextView, android.view.View
    public void setPaddingRelative(int i5, int i7, int i9, int i10) {
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet, int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.ExtendedFloatingActionButton, i5, i7, new int[0]);
        ...
        int i9 = typedArrayObtainStyledAttributes.getInt(R.styleable.ExtendedFloatingActionButton_extendStrategy, 1);
        this.extendStrategyType = i9;
        WeakHashMap weakHashMap = W.f7199a;
        this.extendedPaddingStart = getPaddingStart();
        this.extendedPaddingEnd = getPaddingEnd();
        AnimatorTracker animatorTracker2 = new AnimatorTracker();
        ChangeSizeStrategy changeSizeStrategy = new ChangeSizeStrategy(animatorTracker2, getSizeFromExtendStrategyType(i9), true);
        ...
        typedArrayObtainStyledAttributes.recycle();
        setShapeAppearanceModel(ShapeAppearanceModel.builder(context2, attributeSet, i5, i7, ShapeAppearanceModel.PILL).build());
        saveOriginalTextCsl();
    }
