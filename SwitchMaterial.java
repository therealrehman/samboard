...
public class SwitchMaterial extends SwitchCompat {
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() {
        if (this.materialThemeColorsThumbTintList == null) {
            ...
            int color2 = MaterialColors.getColor(this, com.samsung.android.keyscafe.R.attr.colorControlActivated);
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i5) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.SwitchMaterial, i5, i7, new int[0]);
