...
class BorderDrawable extends Drawable {
    ...
    public void setGradientColors(int i5, int i7, int i9, int i10) {
        this.topOuterStrokeColor = i5;
        this.topInnerStrokeColor = i7;
