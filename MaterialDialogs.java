...
public class MaterialDialogs {
    ...
    public static Rect getDialogBackgroundInsets(Context context, int i5, int i7) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, null, R.styleable.MaterialAlertDialog, i5, i7, new int[0]);
