...
class ChipTextInputComboView extends FrameLayout implements Checkable {
    ...
    public void setChecked(boolean z9) {
        this.chip.setChecked(z9);
        this.editText.setVisibility(z9 ? 0 : 4);
        this.chip.setVisibility(z9 ? 8 : 0);
        if (isChecked()) {
            ViewUtils.requestFocusAndShowKeyboard(this.editText, false);
        }
    }

    public void setChipDelegate(C0210b c0210b) {
        W.i(this.chip, c0210b);
    }

    public void setCursorVisible(boolean z9) {
        this.editText.setCursorVisible(z9);
    }
